        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <div className="hero-buttons">
             ...
             <a href="https://github.com/devareakonda/durga-portfolio/blob/main/public/DURGA%20PRASAD.pdf" download="Durga_Prasad_Resume.pdf"> <button className="btn btn-secondary">Download Resume</button></a>
            </div>
          </div>
